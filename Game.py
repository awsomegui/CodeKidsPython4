...
class Fighter:
    ...
    def attack(self, opponent):
        ...
        if spoil_attack:
            ...
            print("")
            print(f"{self.__name}'s attack succeeded! {opponent.__name} lost {self.__power} HP!")
    ...
    def heal(self):
        ...
        if spoil_heal:
            print("")
            print("{self.__name}'s heal failed!")
            return False
        else:
            print("")
...
if __name__ == '__main__':
    ...
    while playerOne.get_health() > 0 and playerTwo.get_health() > 0:
        ...
        print(f'{activePlayer.get_name()}... Chose your move...')
